        ...
        public void Facing()
        {
            ...
            switch (CountOfDesignActions)
            {
                ...
                case 3:
                    ...
                    Console.WriteLine("'Audi' has been printed on the wheels of " + TransportInfo);
                    break;
                case 4:
                    if (GetBodyType() == BodyType.Sedan) {
                        DesignInfo += "\n4. Print 'Audi sport' on the back window";
                        Console.WriteLine("'Audi sport' has been printed on the back window of " + TransportInfo);
                    } else
                    {
                        DesignInfo += "\n4. Print 'Audi' on the back window";
                        Console.WriteLine("'Audi' has been printed on the back window of " + TransportInfo);
                    }
                    break;
                default:
