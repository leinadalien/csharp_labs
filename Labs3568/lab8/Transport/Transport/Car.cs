...
namespace Transport
{
    ...
    {   
        ...
        private static void ClassicBeep()
        {
            Console.WriteLine("Beeeeeep");
        }
        private bool IsPolice = false;
        private static void PoliceBeep()
        {
            Console.WriteLine("Bwuuh");
        }
        public delegate void beeping();
        public beeping Beep = ClassicBeep;
        ...
        public static void MakePolice(Car car)
        {
            car.IsPolice = true;
            car.Beep = PoliceBeep;
        }
        public static void UnMakePolice(Car car)
        {
            car.IsPolice = false;
            car.Beep = ClassicBeep;
        }
        public static void MakePolice(Car[] cars)
        {
        ...
        public static void UnMakePolice(Car[] cars)
        {
            foreach (Car car in cars)
            {
                car.IsPolice = false;
