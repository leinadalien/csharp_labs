...
namespace Triangle
{
    class Program
    {
        ...
        {
            if (SidesAndCorners[0] + SidesAndCorners[1] > SidesAndCorners[2] && SidesAndCorners[1] + SidesAndCorners[2] > SidesAndCorners[0] && SidesAndCorners[0] + SidesAndCorners[2] > SidesAndCorners[1] && SidesAndCorners[3] + SidesAndCorners[4] + SidesAndCorners[5] == Math.PI)
            {
            ...
            {
                Console.WriteLine("Такого треугольника не существует, нажмите любую клавишу чтобы выйти в меню");
                Console.ReadKey(true);
            }
        }
